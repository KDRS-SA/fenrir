...
public class Fonds implements Serializable {
	...
	public String toString() {
		return "Fonds [id=" + id + ", systemId=" + systemId + ", title="
				...
				+ finalisedBy + ", referenceSeries=" + referenceSeries
				+ ", referenceParentFonds=" + referenceParentFonds
				+ ", referenceChildFonds=" + referenceChildFonds
				+ ", referenceStorageLocation=" + referenceStorageLocation
				+ ", referenceFondsCreator=" + referenceFondsCreator + "]";
	}
