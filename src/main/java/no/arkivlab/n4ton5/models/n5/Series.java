...
public class Series implements Serializable {
	...
	public String toString() {
		return "Series [id=" + id + ", systemId=" + systemId + ", title="
				...
				+ ", referencePrecursor=" + referencePrecursor
				+ ", referenceSuccessor=" + referenceSuccessor
				+ ", referenceClassificationSystem="
				+ referenceClassificationSystem + ", referenceFile="
				+ referenceFile + ", referenceRecord=" + referenceRecord + "]";
	}
