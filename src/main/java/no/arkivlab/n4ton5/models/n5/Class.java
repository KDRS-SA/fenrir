...
public class Class implements Serializable {
	...
	public String toString() {
		return "Class [id=" + id + ", systemId=" + systemId + ", classId="
				...
				+ finalisedBy + ", referenceKeyword=" + referenceKeyword
				+ ", referenceClassificationSystem="
				+ referenceClassificationSystem + ", referenceParentClass="
				+ referenceParentClass + ", referenceChildClass="
				+ referenceChildClass + ", referenceFile=" + referenceFile
